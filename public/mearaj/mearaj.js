...
TweenMax.set("#soccer1", {
    opacity: 1
});

TweenMax.set(["#soccer2", "#basket"], {
    autoAlpha: 0,
    display: "none"
});
...
function step2_bodyTL() {
    ...
    timeline.staggerFromTo(".soccer2_fill > *", 0.2, {
            scale: 0,
...
function step3_bodyTL() {
    ...
    timeline.staggerFromTo(".basket_fill > *", 0.3, {
        scale: 0,
        y: 300,
        transformOrigin: "0% 0%"
    }, {
